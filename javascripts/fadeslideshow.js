...
var fadeSlideShow_descpanel={
	...
	fontStyle: 'bold 14px 微软雅黑', //font style for text descriptions
...
fadeSlideShow.routines={
	...
	adddescpanel:function($, setting){
		...
		$('<div class="descpanelbg"></div><div class="descpanelfg"></div>') //create inner nav panel DIVs
			...
			.eq(0).css({background:'#fff', opacity:0.0}).end() //"descpanelbg" div
			.eq(1).css({color:'#444', textAlign:'center'}).html(setting.closebutton + setting.longestdesc).end() //"descpanelfg" div
